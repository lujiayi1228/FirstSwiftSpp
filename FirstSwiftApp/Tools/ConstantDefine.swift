...
/// 是否是全面屏
let deviceIsMainScreenIPhone = (modelName == "iPhone10,6" || modelName == " ") ? true : false
...
let screenCenterPoint = CGPoint.init(x: screenCenterX, y: screenCenterY)

let naviHeight : CGFloat = deviceIsMainScreenIPhone ? 64 + 24 : 64
